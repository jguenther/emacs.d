...
(custom-set-variables
 ...
 '(org-agenda-files
   (quote
    ("~/org/trello/sprint_7.trello" "/Users/jguenther/org/vendasta.org" "/Users/jguenther/org/snippets.org" "/Users/jguenther/org/todo.org")))
 ...
 '(package-selected-packages
   (quote
    (zone-select zone-rainbow buttercup multishell discover volatile-highlights go-playground go-projectile go-direx go-snippets go-complete go-errcheck go-eldoc go-scratch go-rename go-stacktracer go-dlv go-mode ox-rst ox-gfm ox-mediawiki angular-snippets angular-mode stickyfunc-enhance itail syslog-mode buffer-flip el-mock org-time-budgets neotree xbm-life swiper-helm org-annotation-helper focus unbound cus-edit+ helm-fuzzier eval-sexp-fu python-info org-linkany ob-perl ob-http ob-sh zop-to-char clojure-quick-repl clonjure-quick-repl clojure-mode-extra-font-locking clojure-cheatsheet cljr-helm imenu-anywhere imenu+ bookmark+ persp-projectile helm-dash helm-ag wgrep-helm helm-projectile helm-orgcard helm-git-grep helm-fuzzy-find helm-dired-recent helm-descbinds helm-bind-key yasnippet pyvenv highlight-indentation find-file-in-project swiper company shell-pop flappymacs pymacs emacs-for-python anaconda-mode anaconda popup-keys quelpa restclient iedit back-button visual-mark achievements magit-tramp diffview string-inflection god-mode project-persist-drawer sr-speedbar flx magit-find-file eshell-did-you-mean org-bullets orgit yari yaml-mode yagist win-switch whole-line-or-region whitespace-cleanup-mode which-key wgrep-ag vc-darcs unfill undo-tree tidy textile-mode tagedit switch-window sql-indent smex smarty-mode skewer-less second-sel scss-mode scratch sass-mode ruby-hash-syntax robe rinari regex-tool redshank realgud rainbow-mode rainbow-delimiters python-x pydoc-info pydoc project-local-variables ppd-sr-speedbar pip-requirements php-mode paredit-everywhere paradox page-break-lines osx-location orglink org-repo-todo org-projectile org-pomodoro org-plus-contrib org-mac-link org-mac-iCal org-jira org-fstree org-cliplink ob-browser mwe-log-commands multiple-cursors move-dup mmm-mode mkdown menu-bar+ matlab-mode magit-svn macrostep lua-mode lively less-css-mode ledger-mode json-mode js-comint jquery-doc jira-markup-mode jinja2-mode jedi-direx isearch+ ipretty info+ indent-guide ibuffer-vc ibuffer-projectile htmlize hl-sexp hl-line+ hippie-expand-slime highlight-symbol highlight-quoted highlight-escape-sequences help-mode+ help-fns+ help+ hayoo guide-key goto-last-change gnuplot gitignore-mode github-clone github-browse-file gitconfig-mode git-wip-timemachine git-timemachine git-messenger git-blame ghci-completion fullframe free-keys flycheck-package flycheck-ledger flycheck-hdevtools flycheck-haskell flx-isearch fill-column-indicator expand-region exec-path-from-shell ess erlang elpy elisp-slime-nav dsvn discover-my-major dired-toggle-sudo dired-sort-menu dired-sort dired-imenu dired-filter dired+ diminish diff-hl default-text-scale dash-at-point darcsum cursor-chg csv-nav csv-mode css-eldoc crontab-mode color-theme-sanityinc-tomorrow color-theme-sanityinc-solarized coffee-mode cl-lib-highlight bug-reference-github browse-kill-ring+ bash-completion avy auto-compile anzu aggressive-indent ag ace-jump-mode ac-slime ac-js2 ac-inf-ruby ac-haskell-process)))
 '(projectile-global-mode t)
 '(safe-local-variable-values
   (quote
    ((python-shell-extra-pythonpaths "/Users/jguenther/Projects/VBC" "/Users/jguenther/Projects/VBC/src" "/Users/jguenther/Projects/VBC/src/lib" "/Users/jguenther/Projects/VBC/test/lib" "/Users/jguenther/Projects/VBC/tools" "/Users/jguenther/Projects/VBC/tools/coverage-3.5.1" "/Users/jguenther/Projects/VBC/tools/minimock" "/usr/local/google_appengine" "/usr/local/google_appengine/lib/webob-1.1.1" "/usr/local/google_appengine/lib/webapp2-2.5.1" "/usr/local/google_appengine/lib/jinja2-2.6" "/usr/local/google_appengine/lib/simplejson" "/usr/local/google_appengine/lib/yaml/lib" "/usr/local/google_appengine/lib/fancy_urllib" "/usr/local/google_appengine/lib/protorpc-1.0")
